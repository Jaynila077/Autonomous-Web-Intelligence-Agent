...
2. **Strict Folder Boundaries:** You are ONLY permitted to create or modify files inside your assigned directory (e.g., `agents/scout/`). Do not touch other developers' files.
...
*   **DEV 3: Extractor Engine & Knowledge Store (Sourav and Swarup)**
    *   **Your Boundary:** `agents/extractor/` and `storage/`
...
1. **Start of Session:**
   ...
   ```
2. **Work Locally:** Build and test your code in your specific `agents/...` folder.
