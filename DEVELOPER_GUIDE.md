...
Before you ask your AI tool to write any code, you must give it the Master System Prompt. This

ensures the AI understands the architectural constraints of the project.
...
Copy and paste content of this file into your AI's custom instructions, system prompt, or initial

## STEP B: Apply Your Personal Task Prompt

Find your specific role below. Copy the prompt and give it to your AI assistant to start
