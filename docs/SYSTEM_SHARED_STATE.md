# SYSTEM CONTRACT: Shared State Definition
...
2. Do NOT write direct agent-to-agent function calls. Communicate strictly by updating `AgentState`.
3. Always return valid, structured JSON/Pydantic outputs.
